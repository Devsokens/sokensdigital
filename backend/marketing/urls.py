...
from marketing.tracking_views import (
    PublicLeadAttachmentUploadView,
...
public_urlpatterns = [
    ...
    path('leads/attachment/', PublicLeadAttachmentUploadView.as_view(), name='public-lead-attachment'),
