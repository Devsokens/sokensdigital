...
from core.constants import (
    ROLE_CAISSIER, ROLE_COMMERCIAL, ROLE_COMPTABLE, ROLE_DEVELOPER, ROLE_DIRECTEUR_FINANCIER,
...
APP_ROLE_CHOICES = [
    ...
    'CHEF_DE_PROJET', 'DEVELOPPEUR', 'COMPTABLE', 'DIRECTEUR_FINANCIER', 'CAISSIER', 'AUTRE',
]
