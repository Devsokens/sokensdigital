...
def send_ticket_resolution_email(ticket_id):
    ...
    Passe par core.mailer.send_mail (API Gmail — core.mail_backend), le seul
    point d'entrée e-mail de l'application ; jamais par django.core.mail
    directement, cf. mailer.py.
    """
    try:
